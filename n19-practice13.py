...
w_graph = Graph.create_from_nodes([a, b, m, s, d, g, n,  l, r])
 
w_graph.connect(a, b, 27)
w_graph.connect(a, m, 15)
w_graph.connect(b, l, 7)
w_graph.connect(b, g, 9)
w_graph.connect(l, n, 10)
w_graph.connect(n, g, 8)
w_graph.connect(n, r, 31)
w_graph.connect(s, m, 15)
w_graph.connect(s, d, 17)
w_graph.connect(s, g, 11)
w_graph.connect(r, d, 32)
w_graph.connect(d, m, 21)
